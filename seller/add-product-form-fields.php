...
<div class="mb-3 form-check">
  ...
  <div class="form-text">Please check this box to accept the terms and conditions before submitting your product. This checkbox is required to add your product.</div>
</div>
...
<script>
// Ensure form submission works properly when "List Product" is clicked
function handleProductSubmit(event) {
  // This function can be expanded if needed for additional validation
  return true; // Allow form to submit normally
}

// Make sure the form can submit properly
document.addEventListener('DOMContentLoaded', function() {
  const form = document.getElementById('productForm');
  if (form) {
    // Add a simple submit handler that doesn't prevent default
